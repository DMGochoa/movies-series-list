...
function setupModels(sequelize) {
  ...
  AudioVisualProductList.init(ProductAudioVisualListSchema, AudioVisualProductListSchema.config(sequelize));
  TypeAudioVisualProduct.init(TypeAudioVisualProductSchema, TypeAudioVisualProduct.config(sequelize));
  AudioVisualProduct.init(AudioVisualProductSchema, AudioVisualProduct.config(sequelize));
  CategoryAudioVisualProduct.init(CategoryAudioVisualProductSchema, CategoryAudioVisualProduct.config(sequelize));
  TypeAudioVisualProduct.init(TypeAudioVisualProductSchema, TypeAudioVisualProduct.config(sequelize));
  CategoryAudioVisualProduct.init(CategoryAudioVisualProductSchema, CategoryAudioVisualProduct.config(sequelize));
  AudioVisualProduct.init(AudioVisualProductSchema, AudioVisualProduct.config(sequelize));
  ItemAudioVisualList.init(ItemAudioVisualListSchema, ItemAudioVisualList.config(sequelize));
